...
references:
  - title: "ISO/IEC 27001:2022 — Information Security Management Systems"
    ...
    domain: "iso.org"
  - title: "ISO/IEC 27017:2026 — Cloud-Specific Security Controls"
    url: "https://www.iso.org/standard/27017?browse=tc"
    description: "Second edition, published July 2026, cancelling and replacing ISO/IEC 27017:2015. Information security controls based on ISO/IEC 27002 for cloud services, restructured around a control taxonomy with attributes."
    domain: "iso.org"
  - title: "ISO/IEC 27018:2025 — PII in Public Cloud"
    url: "https://www.iso.org/standard/27018?browse=tc"
    description: "Third edition, published August 2025. Guidelines for protection of personally identifiable information in public clouds acting as PII processors — the standard most directly aligned with GDPR Article 28 obligations on cloud processors."
    domain: "iso.org"
  - title: "ISO/IEC 27701:2025 — Privacy Information Management"
    url: "https://www.iso.org/standard/27701?browse=tc"
    description: "Second edition, published October 2025, redrafted as a stand-alone management system standard rather than an extension to ISO/IEC 27001. Sets requirements for a Privacy Information Management System (PIMS)."
    domain: "iso.org"
...
| **ISO/IEC 27017** | 2026 (ed. 2) | Cloud-specific extension of 27002 | Audit attestation; often paired with 27001 |
| **ISO/IEC 27018** | 2025 (ed. 3) | PII protection in public cloud — processor obligations | Audit attestation; often paired with 27001 |
| **ISO/IEC 27701** | 2025 (ed. 2) | Privacy Information Management System (PIMS) — stand-alone since the 2025 edition | Certification in its own right; commonly run with 27001 |
...
- **Additional cloud-specific controls** on top of that guidance. The 2015 edition carried seven of them, covering shared roles and responsibilities, removal of cloud service customer assets, segregation in virtual computing environments, virtual machine hardening, administrator’s operational security, monitoring of cloud services, and alignment of virtual and physical networks. **The 2026 edition restructured this**: ISO records that the document now presents controls "using a simple taxonomy and associated attributes", and that "some controls have been merged, some have been removed and several new controls have been introduced". Do not quote the old count of seven against a certificate issued to the new edition.
...
ISO 27701 **used to be an extension to 27001**. That changed with the second edition. ISO/IEC 27701:2025, published in October 2025, "has been redrafted as a stand-alone management system standard" in ISO’s own words, and the 2019 edition is withdrawn. The title changed with it: the 2019 edition was called "Extension to ISO/IEC 27001 and ISO/IEC 27002 for privacy information management", the 2025 edition is "Privacy information management systems — Requirements and guidance".

The practical consequence is that **27001 is no longer a prerequisite**. An organisation can certify to 27701 on its own. Most still run it alongside 27001, because the two management systems share their structure and most of their evidence, and because a privacy management system with no security management system underneath it is a thin claim. But that is now a choice rather than a rule.

Certificates issued against the 2019 edition are still in circulation and will be for some time. When you are handed one, check which edition it names — a 2019-edition certificate necessarily came with a 27001 certificate, a 2025-edition one need not have.
...
- 27017 extends 27002 for cloud-specific concerns and addresses both provider and customer roles. The 2026 second edition restructured the controls, so the old "seven additional controls" shorthand no longer describes it.
- 27018 extends 27002 for PII protection in public cloud — the standard most directly aligned with GDPR Article 28.
- 27701 adds a Privacy Information Management System (PIMS). Since the **2025 second edition it is stand-alone**, so 27001 is no longer a prerequisite, though the two are usually run together. Check which edition a certificate names.
