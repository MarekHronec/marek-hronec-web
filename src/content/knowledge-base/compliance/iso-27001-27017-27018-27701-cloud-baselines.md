...
- See national framework articles ([Slovakia KsVC](./slovakia-ksvc-mirri-government-cloud), [Germany BSI C5](./germany-bsi-c5-cloud-attestation), [Spain ENS](./spain-ens-national-security-framework), [Italy ACN](./italy-acn-cloud-qualification), [France SecNumCloud](./france-anssi-secnumcloud-qualification)) for how each uses the ISO stack as its reference point.
