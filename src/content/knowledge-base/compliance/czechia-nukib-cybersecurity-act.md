...
- **[ISO/IEC 27001](./iso-27001-27017-27018-27701-cloud-baselines)** and the broader 27000 family — referenced as compliance baseline.
- **NIST Cybersecurity Framework** — referenced in NÚKIB guidance.
- **[NIS2 supply-chain expectations](./nis2-supply-chain-cloud-providers)** — the operative bar for cloud provider assessment.
...
- **What to read next:** [NIS2 Supply Chain](./nis2-supply-chain-cloud-providers) for the customer-side obligation Czech regulated subjects must satisfy; [ISO 27001/27017/27018](./iso-27001-27017-27018-27701-cloud-baselines) and [SOC 2](./soc-2-reports-how-to-actually-read-them) for the international evidence baseline; [Slovakia KsVC](./slovakia-ksvc-mirri-government-cloud) and [Poland KSC](./poland-ksc-cybersecurity-system) for adjacent CEE regulatory comparisons.
