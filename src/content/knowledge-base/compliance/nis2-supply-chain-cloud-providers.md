...
- See country articles for the per-country NIS2 transposition status and incident-reporting destinations; see [DORA article](./dora-for-cloud-financial-sector-overlay) for the financial-sector overlay; see [Article 28 / EU Cloud CoC article](./gdpr-article-28-and-eu-cloud-code-of-conduct) for the GDPR overlay.
